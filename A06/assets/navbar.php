    ...
    <div class="navigation collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
        <?php if (isset($_SESSION['user'])): ?>
          <a class="nav-link" aria-current="page" href="../A06/home.php">Home</a>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link" href="../A06/profile.php">Profile</a>
        </li>
        <?php else: ?>
        ...
        <?php if (isset($_SESSION['user'])): ?>
          <li class="nav-item">
            <a class="nav-link" href="../A06/logout.php">Logout</a>
          </li>
        <?php endif; ?>
      </ul>
    </div>
